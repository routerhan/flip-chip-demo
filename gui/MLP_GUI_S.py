...
class MaterialDialog(QDialog):
    def __init__(self, parent=None, init_values=None):
        ...
        labels = [
            "楊氏模數1 (MPa)", "蒲松比1",
            "楊氏模數2 (MPa)", "蒲松比2",
            "CTE1(ppm/K)", "CTE2(ppm/K)", "Tg (°C)",
        ]
        self.keys = [
            "young_modulus_1", "poisson_ratio_1",
            "young_modulus_2", "poisson_ratio_2",
            "cte1", "cte2", "tg2",
        ]
...
# ---------------- 主視窗 ----------------
class MainWindowMLPS(QMainWindow):
    def __init__(self):
        super().__init__()
        ...
        form_layout.addRow("Jig中心矩形孔(mm):", hole_row)
    ...
    def predict(self):
        try:
            ...
            # 特徵順序：與訓練一致
            basic = [magnet, jig, copper, B1, W1, substrate]
